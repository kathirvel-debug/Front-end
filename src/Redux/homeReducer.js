...
export const storeApi= createAsyncThunk ("comment/get",()=>{
  return axios.get("https://full-stack-project-1.onrender.com/api/ecom/products")
})
export const searchAsync= createAsyncThunk("searchThuk",async (payload)=>{
const response=await fetch("https://full-stack-project-1.onrender.com/api/ecom/search",{
  method:"POST",
  headers:{
...
export const filterApi= createAsyncThunk("filter",async (payload)=>{
  const response=await fetch("https://full-stack-project-1.onrender.com/api/ecom/filter",{
    method:"POST",
    headers:{
      "Content-Type": "application/json"
    },
